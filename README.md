...
1. **Phase J: Product UX Reframe** — Pivot core modules to "프론티어 마스터" (Frontier Master), prediction-betting "히어로즈 페이트" (Hero's Fate), "스미스 앤 셔드" (Smith & Shards), and "전선 지휘부" (Frontline Command). (Phase J-0, J-1, J-2A, J-2B, J-2C, J-2D, J-2E, and J-2F complete; Phase J-3A, J-3A-1 & J-3A-2 weapon redesign spec drafted; implementation pending).
