...
1. **Phase J: Product UX Reframe** — Pivot core modules to "프론티어 마스터" (Frontier Master), prediction-betting "히어로즈 페이트" (Hero's Fate), "스미스 앤 셔드" (Smith & Shards), and "전선 지휘부" (Frontline Command). (Phase J-0 to J-3E-2 sandbox complete; Phase J-4A unified UX audit, J-4B first-time player onboarding rework, J-4C first-click CTA patch, J-4D Immediate Dopamine Feedback Pass, and J-4E Cross-System War Cohesion Pass complete).
