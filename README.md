...
1. **Phase J: Product UX Reframe** — Pivot core modules to "프론티어 마스터" (Frontier Master), prediction-betting "히어로즈 페이트" (Hero's Fate), "스미스 앤 셔드" (Smith & Shards), and "전선 지휘부" (Frontline Command). (Phase J-0 & J-1 complete, J-2A spec complete).
